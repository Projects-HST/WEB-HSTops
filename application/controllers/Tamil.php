...
class Tamil extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('tamil/home',$datas);
	...
	public function about_ops()
	{
		...
		$this->load->view('tamil/header',$datas);
		$this->load->view('tamil/about_ops',$datas);
		$this->load->view('tamil/footer',$datas);
	}
	...
	public function about_party()
	{
		...
		$this->load->view('tamil/header',$datas);
		$this->load->view('tamil/about_party',$datas);
		$this->load->view('tamil/footer',$datas);
	}
	...
	public function posts($rowno=0)
	{
			...
			$config['base_url'] = base_url().'tamil/posts';
		...
		// Load view
			$this->load->view('tamil/header',$datas);
			$this->load->view('tamil/posts',$data);
			$this->load->view('tamil/footer',$datas);
	...
	public function events($rowno=0)
	{
			...
			// Pagination Configuration
			$config['base_url'] = base_url().'tamil/events';
			$config['use_page_numbers'] = TRUE;
			$config['total_rows'] = $allcount;
			$config['per_page'] = $rowperpage;
		...
		// Load view
			$this->load->view('tamil/header',$datas);
			$this->load->view('tamil/events',$data);
			$this->load->view('tamil/footer',$datas);
	...
	public function post_details($post_id)
	{
		...
		$this->load->view('tamil/header',$datas);
		$this->load->view('tamil/post_details',$datas);
		$this->load->view('tamil/footer',$datas);
	}
	...
	public function photos($rowno=0)
	{
			...
			// Pagination Configuration
			$config['base_url'] = base_url().'tamil/photos';
			$config['use_page_numbers'] = TRUE;
			$config['total_rows'] = $allcount;
			$config['per_page'] = $rowperpage;
		...
		// Load view
			$this->load->view('tamil/header',$datas);
			$this->load->view('tamil/photos',$data);
			$this->load->view('tamil/footer',$datas);
	...
	public function videos($rowno=0)
	{
		...
		// Load view
			$this->load->view('tamil/header',$datas);
			$this->load->view('tamil/videos',$data);
			$this->load->view('tamil/footer',$datas);
	...
	public function photos_gallery($post_id)
	{
		...
		$this->load->view('tamil/header',$datas);
		$this->load->view('tamil/photos_gallery',$datas);
		$this->load->view('tamil/footer',$datas);
	}
	...
	public function search_posts($rowno=0)
	{
		$datas['socialmedia'] = $this->websitemodel->get_socialmedia();
			...
			// Pagination Configuration
			$config['base_url'] = base_url().'tamil/search_posts';
			$config['use_page_numbers'] = TRUE;
			$config['total_rows'] = $allcount;
			$config['per_page'] = $rowperpage;
		...
		// Load view
			$this->load->view('tamil/header',$datas);
			$this->load->view('tamil/search_result',$data);
			$this->load->view('tamil/footer',$datas);
