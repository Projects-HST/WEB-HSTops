...
//-----------------------------------------------//
	...
	public function spv_personal()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_personal($user_id);
...
//-----------------------------------------------//
	...
	public function spv_political()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_political($user_id);
...
//-----------------------------------------------//
	...
	public function spv_positionheld()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_positionheld($user_id);
...
//-----------------------------------------------//
	...
	public function spv_awards()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_awards($user_id);
...
//-----------------------------------------------//
	...
	public function spv_notable()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_notable($user_id);
...
//-----------------------------------------------//
	...
	public function spv_namakkaga()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_namakkaga($user_id);
...
//-----------------------------------------------//
	...
	public function spv_ias_academy()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Spv_ias_academy($user_id);
...
//-----------------------------------------------//
	...
	public function party_elections()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apiandroidmodel->Party_elections($user_id);
