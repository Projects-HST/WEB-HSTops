                ...
                <div class="col-lg-4 col-md-6">
                    <div class="icon-box-style-05 margin-bottom-30">
                        <div class="causes-img">
                            <a href="<?php echo base_url(); ?>tamil/photos_gallery/<?php echo base64_encode($rows['id']*98765); ?>/"><img src="<?php echo $assets_url.$rows['nf_cover_image'];?>" alt=""></a>
                        </div>
                        <div class="sb-content">
                            <h4><a href="<?php echo base_url(); ?>tamil/photos_gallery/<?php echo base64_encode($rows['id']*98765); ?>/"><?php echo $rows['title_ta'];?></a></h4>
                        </div>
                    </div>
                </div>
			<?php } ?>
