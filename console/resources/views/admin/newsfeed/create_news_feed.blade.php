                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group row">
                                <div class="col-md-6">
                                  ...
                                  <textarea name="description_en" class="form-control" rows="10" cols="80" id="description_en" placeholder=""></textarea>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <textarea name="description_ta" class="form-control" rows="10" cols="80" id="description_ta" placeholder=""></textarea>
